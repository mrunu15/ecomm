...
function MyOrders() {
  ...
  // Filter out orders that have empty orderItems
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="max-w-6xl lg:mx-auto md:mx-6 mx-2 justify-center items-center p-6 bg-gradient-to-r from-[#e6f9d8] via-[#c9efb5] to-[#a5d64c] dark:bg-gray-800 shadow-lg rounded-2xl mt-24 min-h-[50vh]">
                ...
                {filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      <span 
                        className={`px-4 py-2 text-sm font-bold text-center rounded-xl ${
                          order.orderStatus === 'Delivered'
                            ? 'text-green-600 bg-yellow-200'
                    ...
                    <td className="px-4 py-3 flex flex-col md:flex-row items-center justify-center gap-2">
                      ...
                      {order.orderStatus === 'Delivered' && (
                        <button
                          className="px-3 py-1 text-sm rounded-md bg-[#F49210] hover:bg-[#DD7106] text-white font-medium shadow-sm transition"
                          onClick={() => {
                            setToast({
